...
### Audio Output
For accessing the audio card of the RPi in C/C++, the ALSA sound library API is used. This can access the output devices and send samples to the 3.5mm jack. @noauthor_alsa_nodate To use the alsa library the API should be installed.
```bash
