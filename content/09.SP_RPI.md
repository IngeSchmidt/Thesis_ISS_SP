...
```{figure} figures/11.SP_RPI/UART.jpg
:label: fig-uart-test
...
The RPi outputs the three different waveforms clearly, with variable amplitude and frequency. In [](#fig-waveforms) the three waveforms can be seen.
<!-- :::{table}
:label: tab-waveform-rpi
:align: center
